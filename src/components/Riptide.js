...
import diagram from "../image/chord-diagram1.png";
import a from "../image/chorus1.png";
import b from "../image/chorus2.png";
import c from "../image/chorus3.png";
...
export default class Riptide extends Component {
  render() {
    return (
      <div className="container">
        <Card.Img style={{ width: "900px" }} variant="top" src={riptide} />
        {chords &&
          chords.map((chords) => {
            return (
              <div className="row">
                ...
                >
                  <Card.Body className="card_body">
                    ...
                    >
                      <b>
                        Difficulty: Novice <br /> Tuning: E A D G B E
                      </b>
                    </Card.Text>
                  </Card.Body>
                </Card>
